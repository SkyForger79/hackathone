...
namespace ToastNotifications
{
    public partial class Notification : Form
    {
        ...
        public Notification(string title, string body, int duration, FormAnimator.AnimationMethod animation, FormAnimator.AnimationDirection direction, Color color, string sound = null)
        {
            InitializeComponent();
        ...
        public new void Show()
        {
            ...
            _playNotificationSound(_sound);
            base.Show();
        }

        private void _playNotificationSound(string sound)
        {
